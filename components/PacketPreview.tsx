...
export default function PacketPreview() {
  ...
  return (
    <div className="rounded-[1.75rem] border border-[var(--border)] bg-[linear-gradient(180deg,rgba(15,23,42,0.96),rgba(15,23,42,0.88))] p-6 shadow-[0_30px_90px_rgba(2,6,23,0.35)] ring-1 ring-white/5">
      <div className="rounded-[1.4rem] border border-white/8 bg-white/5 p-5 backdrop-blur-sm">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          {metrics.map(metric => (
            <div key={metric.label} className="rounded-2xl border border-white/8 bg-[rgba(255,255,255,0.04)] p-4">
        ...
        <div className="mt-5 grid gap-3 rounded-2xl border border-white/8 bg-[rgba(255,255,255,0.03)] p-4 sm:grid-cols-[1.3fr_0.7fr] sm:items-center">
          <div>
