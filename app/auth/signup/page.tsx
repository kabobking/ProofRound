...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
      <div className="w-full max-w-md opacity-0 translate-y-2 transition-all duration-500 ease-out" style={{ animation: 'fadeInUp 0.6s ease-out forwards' }}>
        <div className="bg-[var(--surface)] rounded-lg border border-[var(--border)] shadow-md p-8">
          ...
          <p className="text-[var(--muted)] mb-6">Join the ProofRound marketplace</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="role" className="block text-sm font-medium text-[var(--text)] mb-1">
                I am a...
              </label>
              <select
                id="role"
