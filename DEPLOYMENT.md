...
|---|---|---|
| `NEXT_PUBLIC_STRIPE_CONNECT_BACKEND_URL` | Founder connect/manage Stripe flow | `https://<your-backend>.vercel.app/api/stripe/connect` |
| `NEXT_PUBLIC_STRIPE_OAUTH_URL` | Direct Stripe OAuth flow | `https://connect.stripe.com/oauth/authorize` |
...
4. Copy the backend URLs into the frontend GitHub Pages env vars:
   - `NEXT_PUBLIC_STRIPE_CONNECT_BACKEND_URL=https://<your-backend>.vercel.app/api/stripe/connect`
   - `NEXT_PUBLIC_STRIPE_OAUTH_URL=https://connect.stripe.com/oauth/authorize` if you use Stripe OAuth directly
